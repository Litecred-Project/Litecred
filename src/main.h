...
public:
    ...
    {
        // litecred: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // litecred: get transaction coin age
...
public:
    ...
    // litecred: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // litecred: two types of block: proof-of-work or proof-of-stake
    ...
    // litecred: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // litecred: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // litecred: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // litecred: block index flags
    enum  
    {
