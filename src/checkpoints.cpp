...
namespace Checkpoints
{
    ...
    // litecred: synchronized checkpoint (centrally broadcasted)
    ...
    // litecred: get last synchronized checkpoint
    ...
    // litecred: only descendant of current sync-checkpoint is allowed
    ...
    // litecred: reset synchronized checkpoint to last hardened checkpoint
...
// litecred: verify signature of sync-checkpoint message
...
// litecred: process synchronized checkpoint
